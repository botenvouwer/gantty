...
month_colors = ('9BBB59', '4BACC6', 'F79646', 'E0D60E', '8064A2', 'C0504D', '9BBB59', '4BACC6', 'F79646', 'E0D60E', '8064A2', 'C0504D')
month_day_colors = ('D8E4BC', 'B7DEE8', 'FCD5B4', 'F8F388', 'CCC0DA', 'E6B8B7', 'D8E4BC', 'B7DEE8', 'FCD5B4', 'F8F388', 'CCC0DA', 'E6B8B7')
...
sum_days_in_month = 1
last_month = 0
for passed_months, year, days_left_in_year, month, month_name, days_in_month, i, week_number in timeIterate:
    ...
    if last_month < month:
        ...
        column_i_end = column_i + weeks_in_month - 1
        ...
        worksheet.merge_cells(start_row=row, start_column=column_i,
                              end_row=row,   end_column=column_i_end)

        last_month = month if month > 12 else 1
